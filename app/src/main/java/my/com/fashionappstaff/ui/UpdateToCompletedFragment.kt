...
import my.com.fashionappstaff.databinding.FragmentUpdateToCompletedBinding
import my.com.fashionappstaff.databinding.FragmentUpdateToDeliveredBinding
import my.com.fashionappstaff.databinding.FragmentUpdateToDeliveryBinding
import my.com.fashionappstaff.util.toBitmap


class UpdateToCompletedFragment : Fragment() {

    private lateinit var binding: FragmentUpdateToCompletedBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentUpdateToCompletedBinding.inflate(inflater,container, false)
        ...
        orderDetail()
        binding.imgOrderDetailsBack.setOnClickListener { nav.navigate(R.id.listDeliveryFragment) }

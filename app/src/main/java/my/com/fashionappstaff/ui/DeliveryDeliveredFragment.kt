...
import my.com.fashionappstaff.databinding.FragmentDeliveryDeliveredBinding
import my.com.fashionappstaff.util.toBitmap

class DeliveryDeliveredFragment: Fragment() {

    private lateinit var binding: FragmentDeliveryDeliveredBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentDeliveryDeliveredBinding.inflate(inflater, container, false)

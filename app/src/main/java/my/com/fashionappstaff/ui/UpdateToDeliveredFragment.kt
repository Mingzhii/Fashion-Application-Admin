...
class UpdateToDeliveredFragment : Fragment() {

    private lateinit var binding: FragmentUpdateToDeliveredBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentUpdateToDeliveredBinding.inflate(inflater,container, false)

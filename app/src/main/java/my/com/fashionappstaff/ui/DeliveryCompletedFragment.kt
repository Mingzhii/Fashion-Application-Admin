...
import my.com.fashionappstaff.databinding.FragmentDeliveryCompletedBinding
import my.com.fashionappstaff.util.toBitmap

class DeliveryCompletedFragment: Fragment() {

    private lateinit var binding: FragmentDeliveryCompletedBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentDeliveryCompletedBinding.inflate(inflater, container, false)
        ...
        adapter = DeliveryAdapter() { holder, product ->
            ...
            holder.root.setOnClickListener {
                if (o != null && p != null) {
                    nav.navigate(R.id.updateToCompletedFragment, bundleOf("id" to product.orderId, "id1" to product.orderProduct,"id2" to product.orderPaymentId ))
                }
            }
        }
        ...
        binding.bottomNavigationDelivery.setOnItemSelectedListener {
            when(it.itemId){
                R.id.nav_paid -> nav.navigate(R.id.listDeliveryFragment)
